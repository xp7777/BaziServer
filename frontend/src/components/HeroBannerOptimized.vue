  ...
  setup() {
    ...
    const banners = [
      { 
        ...
        placeholder: banner1Placeholder,
        title: '鬼谷文化', 
        subtitle: '纵横捭阖，古今通达' 
      },
      { 
        ...
        placeholder: banner2Placeholder,
        title: '法天象地', 
        subtitle: '国学指引，人生赋能' 
      },
      { 
        ...
        placeholder: banner3Placeholder,
        title: '国学传承', 
        subtitle: '强者风范，生生不息' 
      },
      { 
        ...
        placeholder: banner4Placeholder,
        title: '道家智慧', 
        subtitle: '天人合一，道法自然' 
      }
    ];
